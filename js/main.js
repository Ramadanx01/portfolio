...
const projects = [
  ...
  },
  {
    ...
    image: `${IMAGE_PATH}system wood.png`,
  ...
  },
  {
    ...
    image: `${IMAGE_PATH}login-system1.jpg.jpg`,
  ...
  {
    id: 8,
    title:"الة حاسبة مخصوصة  لحساب المتر المكعب ",
  ...
  {
    id: 10,
    title: "Vikings Auto Trade",
    description: "Vikings Auto Trade هو موقع عصري ومتجاوب مصمم لمعرض سيارات، يتميز بتصميم نظيف، ودمج خرائط جوجل التفاعلية لعدة مواقع، وسهولة التصفح. تم تطويره باستخدام HTML وCSS وJavaScript وBootstrap مع التركيز على تجربة المستخدم وإبراز هوية العلامة التجارية.",
    image: `${IMAGE_PATH}vikings_auto_trade.jpg`,
    live: `https://ramadanx01.github.io/Viking/`,
    github: null,
    technologies: ["HTML5", "CSS3", "Bootstrap 5","typeScript","JavaScript","css animation"]
  },
];
